...
export const Example = () => {
  ...
  return (
    <div className="vstack gap-md" style={{ maxWidth: '20rem' }}>
      ...
      <div
        className={`d-flex align-items-center gap-md${loading ? ' skeleton-glow' : ''}`}
        aria-hidden={loading || undefined}
      >
        <SkeletonLoader loading={loading} component={Avatar} size="lg">
        ...
        <div className="font-lg flex-grow-1">
